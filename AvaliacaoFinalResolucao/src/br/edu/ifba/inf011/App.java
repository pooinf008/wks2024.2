...
public class App {
	...
	public void run() throws Exception {
		...
		NotificadorFactory factory = new NotificadorFactory();
		factory.setHandle(handle);
		Notificador notificador = factory.create(TipoNotificador.SIMPLES); 
//		NotificadorMultiModo notificador = (NotificadorMultiModo) factory.create(TipoNotificador.MULTIMODO);
