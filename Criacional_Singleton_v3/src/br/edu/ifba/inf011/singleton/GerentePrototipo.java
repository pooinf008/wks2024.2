...
public class  GerentePrototipo{
	...
	private static GerentePrototipo instance;
	
	private static GerentePrototipo registrado;
	
	public static GerentePrototipo registrar(GerentePrototipo registrado) {
		return GerentePrototipo.registrado = registrado;
	}
	
	
	public static GerentePrototipo instance() {
		if(GerentePrototipo.instance == null)
			GerentePrototipo.instance = new GerentePrototipo();
		return GerentePrototipo.instance;
	}	
	
	public static GerentePrototipo get() {
		if(GerentePrototipo.registrado == null)
			GerentePrototipo.registrado = new GerentePrototipo();
		return GerentePrototipo.registrado;
	}		
